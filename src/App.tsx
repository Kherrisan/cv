    ...
    <div className='flex min-h-screen flex-col'>
      <div className="mt-8 flex-1 flex flex-col justify-center">
        <div className="mx-auto max-w-4xl px-6 mb-6">
          ...
          <Publication year={2024} title='An Accurate and Lightweight Intrusion Detection Model Deployed on Edge Network Devices' authors='Y Ao, J Tao, D Zou, W Sun, L Yu' source='2024 International Joint Conference on Neural Networks (IJCNN)' href='' rank='A'/>
          ...
          <Publication year={2024} title='A Preference-Driven Malicious Platform Detection Mechanism for Users in Mobile Crowdsensing' authors='H Wang, J Tao, D Chi, Y Gao, D Zou, Y Xu' source='IEEE Transactions on Information Forensics & Security' href='' rank='A'/>
