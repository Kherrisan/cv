...
import { faCircleInfo, faEnvelope, faGraduationCap } from '@fortawesome/free-solid-svg-icons'
    ...
    <div className="grid grid-cols-10 sm:grid-cols-12 pt-4">
      ...
      <div className="col-span-10">
        ...
        <div className='heading-text font-bold'>
          <a href='https://dl.acm.org/doi/10.1145/3579093' target='_blank' rel="noreferrer">
            {title}
          </a>
        </div>
  ...
  return (
    <div className="mt-8 flex-1 flex flex-col justify-center">
      <div className="container mx-auto max-w-4xl px-6 mb-6">
        ...
        <Publication year={2022} title='Benefit-Oriented Task Offloading in UAV-Aided Mobile Edge Computing: An Approximate Solution' authors='Y Gao, J Tao, H Wang, Z Wang, D Zou, Y Xu' source='Preprint' href='https://assets.researchsquare.com/files/rs-1604586/v1_covered.pdf?c=1651681336' />
        ...
        <footer className='primary-text p-4 text-center text-xs mt-12'>
          <div >
            备案号xxxxxxxx
          </div>
        </footer>
